Page({
  ...
  data:{
    ...
    duration: 1000,
    list:[
      {"id":'1',"number":'3','type':'0'},
      { "id": '1', "number": '64', 'type': '0' },
      { "id": '1', "number": '3', 'type': '1' },
      { "id": '1', "number": '3', 'type': '0' },
      { "id": '1', "number": '3', 'type': '0' },
      { "id": '1', "number": '3', 'type': '0' },
      { "id": '1', "number": '3', 'type': '1' },
      { "id": '1', "number": '78', 'type': '0' },
      { "id": '1', "number": '3', 'type': '0' },
      { "id": '1', "number": '3', 'type': '0' },
      { "id": '1', "number": '3', 'type': '0' },
      { "id": '1', "number": '3', 'type': '1' },
  ...
  goToParticulars: function (e) {
    var particularsId = e.currentTarget.dataset.id;
    wx.navigateTo({
      url: "carportParticulars/carportParticulars?id=" + particularsId
    })
  },
